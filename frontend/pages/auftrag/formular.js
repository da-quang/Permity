...
export default function Formular() {
    ...
    useEffect(() => {
        fetch(`http://palmiest-hornet-1388.dataplicity.io/api/KSV/select?ebene=1`)
...
function loadEbene2(){
    ...
    useEffect(() => {
        fetch(`http://palmiest-hornet-1388.dataplicity.io/api/KSV/select?ksv=${ksv1}&ebene=2`)
            .then((response) => response.json())
    ...
    useEffect(() => {
        fetch(`http://palmiest-hornet-1388.dataplicity.io/api/KSV/select?ksv=${ksv1}&ebene=3`)
            .then((response) => response.json())
            .then((data5) => setData5(data5));
    }, []);

    useEffect(() => {
        fetch(`http://palmiest-hornet-1388.dataplicity.io/api/KSV/select?ksv=${ksv1}&ebene=4`)
            .then((response) => response.json())
            .then((data6) => setData6(data6));
    }, []);

    useEffect(() => {
        fetch(`http://palmiest-hornet-1388.dataplicity.io/api/KSV/select?ksv=${ksv1}&ebene=5`)
            .then((response) => response.json())
            .then((data7) => setData7(data7));
    }, []);

    useEffect(() => {
        fetch(`http://palmiest-hornet-1388.dataplicity.io/api/KSV/select?ksv=${ksv1}&ebene=6`)
            .then((response) => response.json())
            .then((data8) => setData8(data8));
    }, []);

    useEffect(() => {
        fetch(`http://palmiest-hornet-1388.dataplicity.io/api/KSV/select?ksv=${ksv1}&ebene=7`)
            .then((response) => response.json())
            .then((data9) => setData9(data9));
    }, []);

    useEffect(() => {
        fetch(`http://palmiest-hornet-1388.dataplicity.io/api/KSV/select?ksv=${ksv1}&ebene=8`)
            .then((response) => response.json())
            .then((data10) => setData10(data10));
    }, []);

    useEffect(() => {
        fetch(`http://palmiest-hornet-1388.dataplicity.io/api/KSV/select?ksv=${ksv1}&ebene=9`)
            .then((response) => response.json())
